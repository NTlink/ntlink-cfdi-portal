<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="wfrCartaPortes.aspx.cs" Inherits="GafLookPaid.wfrCartaPortes" %>
                ...
                <tr>
                    ...
                    <td >
                        <asp:DropDownList runat="server" ID="ddlTipoDocumento" AutoPostBack="True" Enabled="false"
                            OnSelectedIndexChanged="ddlTipoDocumento_SelectedIndexChanged" Width="213px" Height="18px">
...
<tr>
         ...
         <td>       <asp:DropDownList runat="server" ID="ddlTipoRelacion" AutoPostBack="True" Enabled="false">
 ...
 <asp:ListItem runat="server" Value="05" Text="Traslados de mercancias facturados previamente" Selected="True"/>
            ...
            DataPlaceHolder="Escriba aquí..." AllowSingleDeselect="true" Height="16px" 
                ...
                <tr>
                    ...
                    <td class="style1">
                     ...
                     <td style="text-align: right; font-weight: 700;" runat="server" visible="false">
                        Descuento</td>
                    <td class="style153">
