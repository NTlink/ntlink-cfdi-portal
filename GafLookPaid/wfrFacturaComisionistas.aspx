<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrFacturaComisionistas.aspx.cs" Inherits="GafLookPaid.wfrFacturaComisionistas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<h1>Generar CFDI Comisionistas</h1>
	<p>
	...
	<table width="90%" >
		...
		<tr>
			...
			<td style="text-align:left"><asp:Label runat="server" ID="lblTipoCambio" 
                    Text="Tipo Cambio USD:" Visible="False" style="text-align: left" /></td>
	...
	<table width="100%" >
        ...
        <tr>
                ...
                <tr>
                <td  style="text-align: right;">
                    <asp:CheckBox ID="cbRetencionIva" runat="server" AutoPostBack="True" 
                        Checked="True" oncheckedchanged="cbRetencionIva_CheckedChanged" 
                        Text="Retención I.V.A." />
                </td>
                <td style="text-align: left">  <asp:TextBox ID="txtRetencionIva" runat="server" Text="10.66" />
                            %
                ...
                <td  style="text-align: right;">
                    <asp:CheckBox ID="cbRetIsr" runat="server" AutoPostBack="True" Checked="True" 
                        oncheckedchanged="cbRetIsr_CheckedChanged" Text="Retención I.S.R." />
                    </td>
                <td style="text-align: left">  <asp:TextBox ID="txtRetIsr" runat="server" Text="10" />
                            %
	...
	<div style="height: 100%; overflow-y: scroll" >
		<asp:GridView runat="server" ID="gvDetalles" AutoGenerateColumns="False"  CssClass="style124" HorizontalAlign="Center"
			...
			<Columns>
				...
				<asp:BoundField HeaderText="Precio Unitario" DataField="Precio" DataFormatString="{0:C}" ItemStyle-HorizontalAlign="left" />
				<asp:BoundField HeaderText="%I.V.A." DataField="PorcentajeIva" ItemStyle-HorizontalAlign="Right" />
				<asp:BoundField HeaderText="I.V.A." DataField="ImporteIva" DataFormatString="{0:C}" ItemStyle-HorizontalAlign="left" />
				<asp:BoundField HeaderText="R. I.V.A." DataField="RetencionIva" DataFormatString="{0:C}" ItemStyle-HorizontalAlign="left" />
			    <asp:BoundField HeaderText="I.S.R." DataField="ISR" DataFormatString="{0:C}" ItemStyle-HorizontalAlign="left" />
			    <asp:BoundField HeaderText="Total" DataField="TotalPartida" DataFormatString="{0:C}" ItemStyle-HorizontalAlign="left" />
