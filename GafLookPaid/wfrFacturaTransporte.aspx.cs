...
{
    public partial class wfrFacturaTransporte : Page
    {
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            {
                detalle.PorcentajeRetencionIva = decimal.Parse((txtRetencion.Text));
        ...
        private void GuardarFactura()
        {
            ...
            if (ValidarFactura())
            {
                ...
                var fact = new facturas
                               {
                                   TipoDocumento = TipoDocumento.FacturaTransportista,
                ...
                fact.Vencimiento = string.IsNullOrEmpty(this.txtDiasRevision.Text) ? fact.Fecha : fact.Fecha.AddDays(int.Parse(this.txtDiasRevision.Text));
                try
                {
        ...
        private byte[] Preview()
        {
            ...
            var fact = new facturas
                           {
                               ...
                               MonedaS = this.ddlMoneda.Text,
                               Cuenta = string.IsNullOrEmpty(this.txtCuenta.Text) ? null : this.txtCuenta.Text,
                               FormaPago = ddlCondicionesPago.SelectedValue,
                               CondicionesPado=txtCondicionesPago.Text
                           };
            ...
            fact.Leyenda = lblLeyenda.Text;
            fact.TipoDocumento = TipoDocumento.FacturaTransportista;
            fact.Fecha = DateTime.Now;
            var ret = decimal.Parse(lblRetencionIva.Text, NumberStyles.Currency);
            if (ret > 0)
                fact.RetencionIva = ret;
        ...
        private void UpdateTotales()
        {
            ...
            {
                this.lblIva.Text = iva.ToString("#0.####", cul);
                ...
                this.lblRetencionIva.Text = retenciones.ToString("#0.00##", cul);
                this.lblLeyenda.Text = "Iva sobre " + conIva.ToString("#0.00##", cul) + " " + lblIva.Text;
            }
            else
            {
                this.lblIva.Text = iva.ToString("C4", cul);
               //this.lblIva.Text = iva.ToString("C", cul);
                var total = subtotal + iva - retenciones;
                this.lblTotal.Text = total.ToString("C", cul);
                this.lblSubtotal.Text = subtotal.ToString("C4", cul);
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            if (edicion.PorcentajeRetencionIva!=null)
            edicion.RetencionIva = ((decimal)edicion.PorcentajeRetencionIva / 100) * edicion.TotalPartida;
