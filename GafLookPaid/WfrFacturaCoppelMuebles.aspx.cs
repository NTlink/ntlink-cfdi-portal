...
{
    public partial class WfrFacturaCoppelMuebles : System.Web.UI.Page
    {
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            var detalle = new facturasdetalle
            {
              ...
              //  Total = Decimal.Round(decimal.Parse(this.txtPrecio.Text) * decimal.Parse(this.txtCantidad.Text), mon),
                ...
                ModeloConcepto = string.IsNullOrEmpty(this.txtModeloConcepto.Text) ? null : this.txtModeloConcepto.Text,
                //CuentaPredial = string.IsNullOrEmpty(this.txtModeloConcepto.Text) ? null : this.txtModeloConcepto.Text
            };
        ...
        protected void gvDetalles_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("Editar"))
            {
                ...
                this.txtModeloConcepto.Text = edicion.ModeloConcepto;
                mpeEdita.Show();
            }
        }
                ...
                for (int x = 0; x < this.gvBuscarConceptos.Rows.Count; x++)
                {
                    ...
                    using (cliente as IDisposable)
                    {
                        ...
                        var detalle = new facturasdetalle
                        {
                            ...
                            Precio = precio,
                            Total = precio * 1,
                            //ModeloConcepto = prod.CuentaPredial,
        ...
        private facturas GetFactura(string iniciales, List<facturasdetalle> detalles)
        {
            ...
            {
                TipoDocumento = TipoDocumento.Coppel,
            ...
            //LLenado de addenda Coppel
            #region Addenda Coppel
            AddendaCoppel addendaCoppel = new AddendaCoppel();
            AddendaRequestForPayment request = new AddendaRequestForPayment();
            //!VERIFICAR FECHA CORRECTA
            //request.DeliveryDate = DateTime.ParseExact(fact.Fecha, "yyyy-MM-dd", CultureInfo.InvariantCulture);
            request.documentStructureVersion = "CPLM1.0";
            ...
            request.requestForPaymentIdentification = new AddendaRequestForPaymentRequestForPaymentIdentification();
            request.requestForPaymentIdentification.entityType = AddendaRequestForPaymentRequestForPaymentIdentificationEntityType.INVOICE;
            //!REQ 1
            request.requestForPaymentIdentification.uniqueCreatorIdentification =
                RequestforPayment_UniqueCreatorIdentification.Text;
            request.orderIdentification = new AddendaRequestForPaymentOrderIdentification()
            {
                referenceIdentification = new AddendaRequestForPaymentOrderIdentificationReferenceIdentification[]
                                                                                    {
                                                                                        new AddendaRequestForPaymentOrderIdentificationReferenceIdentification()
                                                                                            {
                                                                                                type = AddendaRequestForPaymentOrderIdentificationReferenceIdentificationType.ON, 
                                                                                                //!ORD ID
                ...
                FechaPromesaEnt = DateTime.ParseExact(txtFechaPromesaEntrega.Text, "dd/MM/yyyy", CultureInfo.InvariantCulture)
            };


           // request.specialInstruction = new AddendaRequestForPaymentSpecialInstruction[]
                                                 //{
                                                 //    new AddendaRequestForPaymentSpecialInstruction() 
                                                 //        {
                                                 //            //! CHANGE. PARSE ENUM.
                                                 //            code = AddendaRequestForPaymentSpecialInstructionCode.ZZZ,
            ...
            //                                        {
            //                                            //Verify to add new elements to array from wfrFacturaAmc71.aspx ! 
            //                                            new requestForPaymentReferenceIdentification()
            //                                                {
            //                                                    //! CHANGE. PARSE ENUM
            //                                                    type = (requestForPaymentReferenceIdentificationType)
            //                                                    Enum.Parse(typeof (requestForPaymentReferenceIdentificationType), AdditionalInformation_ListBox_Type.SelectedValue),
            //                                                    Value = AdditionalInformation_ReferenceIdentification.Text
            //                                                },
            //                                        };
            //request. = new requestForPaymentBuyer();
            //////! Buyer GLN
            //request.buyer.gln = BuyerSeller_GlnBuyer.Text;
            request.seller = new AddendaRequestForPaymentSeller();
            //! Seller GLN
            request.seller.gln = BuyerSeller_GlnSeller.Text;
            request.seller.alternatePartyIdentification = new AddendaRequestForPaymentSellerAlternatePartyIdentification();
            request.seller.alternatePartyIdentification.type = AddendaRequestForPaymentSellerAlternatePartyIdentificationType.SELLER_ASSIGNED_IDENTIFIER_FOR_A_PARTY;
            //! Alternate PrtId
            request.seller.alternatePartyIdentification.Value = BuyerSeller_AlternatePrtyId.Text;
            request.seller.IndentificaTipoProv = "1";
            
            request.shipTo = new AddendaRequestForPaymentShipTo()
            {
                gln = Shipto_Gln.Text,
                nameAndAddress = new AddendaRequestForPaymentShipToNameAndAddress()
                {
                    ...
                    streetAddressOne = new string[] { Shipto_StreetAddress.Text },
                    city = new string[] { Shipto_City.Text },
                    postalCode = new string[] { Shipto_PostalCode.Text }
                },
                BodegaDestino = txtBodegaDestino.Text,
                BodegaReceptora = txtBodegaReceptora.Text
            };
            request.currency = new AddendaRequestForPaymentCurrency[]
                                       {
                                           new AddendaRequestForPaymentCurrency()
                                               {
                                                   //! Change ISO CODE ENUM
                                                   currencyISOCode = (AddendaRequestForPaymentCurrencyCurrencyISOCode)
                                                   Enum.Parse(typeof(requestForPaymentCurrencyCurrencyISOCode),Currency_ListBox_ISOCode.SelectedValue),
                                                   ...
                                                   currencyFunction = new AddendaRequestForPaymentCurrencyCurrencyFunction[]
                                                   {(AddendaRequestForPaymentCurrencyCurrencyFunction)Enum.Parse
                                                    (typeof(AddendaRequestForPaymentCurrencyCurrencyFunction),Currency_ListBox_CurrencyFunction.SelectedValue)
                                                   },
                                                   //! Text Parse 
            ...
            //                //Verify... 
            //                value = txtFechaPago.Text
            //            }
            //        },
            //    }

            //};
            request.FleteCaja = new AddendaRequestForPaymentFleteCaja()
                                    {
                                        type =
                                            (AddendaRequestForPaymentFleteCajaType)
                                            Enum.Parse(typeof (AddendaRequestForPaymentFleteCajaType),
                                                       ddlFleteCaja.SelectedValue),
                                        Value = txtFleteCaja.Text
                                    };
            request.allowanceCharge = new AddendaRequestForPaymentAllowanceCharge[]
                                              {
                                                  new AddendaRequestForPaymentAllowanceCharge()
                                                      {
                                                          settlementType = AddendaRequestForPaymentAllowanceChargeSettlementType.BILL_BACK,
                                                          allowanceChargeType = AddendaRequestForPaymentAllowanceChargeAllowanceChargeType.ALLOWANCE_GLOBAL,
                                                          monetaryAmountOrPercentage = new AddendaRequestForPaymentAllowanceChargeMonetaryAmountOrPercentage()
                                                                                           {
                                                                                               rate = new AddendaRequestForPaymentAllowanceChargeMonetaryAmountOrPercentageRate()
                                                                                                          {
                                                                                                              @base = AddendaRequestForPaymentAllowanceChargeMonetaryAmountOrPercentageRateBase.INVOICE_VALUE,
                                                                                                              //Obligatorio Vista.|
                                                                                                              percentage = Decimal.Parse(ReqForPayment_Percentage.Text)
                                                                                                          }
                                                                                           }
                                                      }
                                              };
            var lineItems = new List<AddendaRequestForPaymentLineItem>();
            int countConceptos = 0;

            foreach (var comprobanteConcepto in detalles)
            {

                AddendaRequestForPaymentLineItem li = new AddendaRequestForPaymentLineItem();
                li.type = "SimpleInvoiceLineItemType";
                li.number = (++countConceptos).ToString();

                li.tradeItemIdentification = new AddendaRequestForPaymentLineItemTradeItemIdentification()
                {
                    gtin = comprobanteConcepto.Codigo
                };

                li.tradeItemDescriptionInformation = new AddendaRequestForPaymentLineItemTradeItemDescriptionInformation()
                {
                    language = AddendaRequestForPaymentLineItemTradeItemDescriptionInformationLanguage.ES,
                    languageSpecified = true,
                    longText = comprobanteConcepto.Descripcion
                };

                li.invoicedQuantity = new AddendaRequestForPaymentLineItemInvoicedQuantity()
                {
                ...
                li.grossPrice = new AddendaRequestForPaymentLineItemGrossPrice()
                {
                    Amount = comprobanteConcepto.Precio
                };

                li.modeloInformation = new AddendaRequestForPaymentLineItemModeloInformation()
                {
                    longText = comprobanteConcepto.ModeloConcepto
                };

                li.totalLineAmount = new AddendaRequestForPaymentLineItemTotalLineAmount()
                {
                    grossAmount = new AddendaRequestForPaymentLineItemTotalLineAmountGrossAmount()
                    {
                ...
                li.netPrice = new AddendaRequestForPaymentLineItemNetPrice()
                                  {
                                      Amount = comprobanteConcepto.Precio
                                  };
               
                li.alternateTradeItemIdentification = new AddendaRequestForPaymentLineItemAlternateTradeItemIdentification[]
                                                          {
                                                              new AddendaRequestForPaymentLineItemAlternateTradeItemIdentification()
                                                                  {
                                                                      type = AddendaRequestForPaymentLineItemAlternateTradeItemIdentificationType.BUYER_ASSIGNED,
                                                                      Text = new string[]{comprobanteConcepto.Codigo}
                                                                  }
                                                              
                                                          };
                li.allowanceCharge = new AddendaRequestForPaymentLineItemAllowanceCharge[]
                                         {
                                             new AddendaRequestForPaymentLineItemAllowanceCharge()
                                                 {
                                                     allowanceChargeType = AddendaRequestForPaymentLineItemAllowanceChargeAllowanceChargeType.ALLOWANCE_GLOBAL,
                                                     monetaryAmountOrPercentage = new AddendaRequestForPaymentLineItemAllowanceChargeMonetaryAmountOrPercentage()
                                                                                      {
                                                                                          percentagePerUnit = "0.00",ratePerUnit = new AddendaRequestForPaymentLineItemAllowanceChargeMonetaryAmountOrPercentageRatePerUnit()
                                                                                                                                       {
                                                                                                                                           amountPerUnit = "0.00"
                                                                                                                                       }
                                                                                      }
            ...
            request.totalAmount = new AddendaRequestForPaymentTotalAmount()
            {
                //! 0 if nullable
                Amount = fact.SubTotal ?? 0
            };

            request.TotalAllowanceCharge = new AddendaRequestForPaymentTotalAllowanceCharge[]
                                                   {
                                                       new AddendaRequestForPaymentTotalAllowanceCharge()
                                                           {
                                                               allowanceOrChargeType = AddendaRequestForPaymentTotalAllowanceChargeAllowanceOrChargeType.ALLOWANCE,
                                                               //! Amount check if null then 0 
                                                               specialServicesType = AddendaRequestForPaymentTotalAllowanceChargeSpecialServicesType.TD,
                                                               specialServicesTypeSpecified = true,
                                                               AmountSpecified = true,
                                                               Amount = (fact.Descuento==null)?0:Decimal.Parse(fact.Descuento)
                                                           }
                                                   };
            request.baseAmount = new AddendaRequestForPaymentBaseAmount()
            {
                //! 0 if nullable
                Amount = fact.SubTotal ?? 0
            };
            var rfpTaxes = new List<AddendaRequestForPaymentTax>();


            var tax = new AddendaRequestForPaymentTax()
            {
                type = AddendaRequestForPaymentTaxType.VAT,
                ...
                taxCategory = AddendaRequestForPaymentTaxTaxCategory.TRANSFERIDO,
            ...
            request.payableAmount = new AddendaRequestForPaymentPayableAmount()
            {
                //! 0 if nullable
                Amount = fact.Total ?? 0
            };
            //!!!!!!!!!!!!!!!!! ADD ADDENDA
            addendaCoppel.requestForPayment = request;
            fact.AddendaCoppelObj = addendaCoppel;
        ...
        private void Clear()
        {
            ...
            this.txtCantidad.Text = this.txtUnidad.Text = this.txtModeloConcepto.Text = string.Empty;
        }
        ...
        protected void gvBuscarConceptos_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            using (cliente as IDisposable)
            {
                ...
                //this.txtModeloConcepto.Text = prod.ModeloConcepto;
        ...
        protected void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            edicion.ModeloConcepto = this.txtModeloItem.Text;
            //edicion.CuentaPredial = this.txtModeloItem.Text;
