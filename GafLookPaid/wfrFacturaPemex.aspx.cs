...
{
    public partial class wfrFacturaPemex : System.Web.UI.Page
    {
        ...
        private facturas CrearFactura(List<facturasdetalle> detalles)
        {
            ...
            {
                TipoDocumento = TipoDocumento.FacturaPemex,
                ...
                //Inicia Addenda PEMEX -- SZ
                FacturasAddendaPemex = new FacturasAddendaPemex()
                {
                    CONTRATO = string.IsNullOrEmpty(this.txtnocontrato.Text) ? null : this.txtnocontrato.Text,
                    O_SURTIMIENTO = string.IsNullOrEmpty(this.txtordensurtimiento.Text) ? null : this.txtordensurtimiento.Text,
                    N_ESTIMACION = string.IsNullOrEmpty(this.txtnoestimacion.Text) ? null : this.txtnoestimacion.Text,
                    P_ESTIMACION = string.IsNullOrEmpty(this.txtperiodoestimacion.Text) ? null : this.txtperiodoestimacion.Text,
                    N_ACREEDOR = string.IsNullOrEmpty(this.txtnoacreedor.Text) ? null : this.txtnoacreedor.Text,
                    C_GESTOR = string.IsNullOrEmpty(this.txtcentrogestor.Text) ? null : this.txtcentrogestor.Text,
                    FINIQUITO = string.IsNullOrEmpty(this.txtfiniquito.Text) ? null : this.txtfiniquito.Text,
                    POSICIONAP = string.IsNullOrEmpty(this.txtposicionap.Text) ? null : this.txtposicionap.Text,
                    AUTORIZA = string.IsNullOrEmpty(this.txtautoriza.Text) ? null : this.txtautoriza.Text,
                    ENTRADA = string.IsNullOrEmpty(this.txtentradasap.Text) ? null : this.txtentradasap.Text,
                    EJERCICIO = string.IsNullOrEmpty(this.txtejercicio.Text) ? null : this.txtejercicio.Text,
                    CEJECUTOR = string.IsNullOrEmpty(this.txtcentroejecutor.Text) ? null : this.txtcentroejecutor.Text,
                    RECEPSAP = string.IsNullOrEmpty(this.txtrecepsap.Text) ? null : this.txtrecepsap.Text,
                    NREMISION = string.IsNullOrEmpty(this.txtnremision.Text) ? null : this.txtnremision.Text,
                    PLAZO = string.IsNullOrEmpty(this.txtplazo.Text) ? null : this.txtplazo.Text,
                    RFCPROVEEDOR = string.IsNullOrEmpty(this.txtrfcproveedor.Text) ? null : this.txtrfcproveedor.Text,
                    REMESA = string.IsNullOrEmpty(this.txtremesa.Text) ? null : this.txtremesa.Text,
                    VUREGION = string.IsNullOrEmpty(this.txtvuregion.Text) ? null : this.txtvuregion.Text,
                    FICHAE = string.IsNullOrEmpty(this.txtfichae.Text) ? null : this.txtfichae.Text,
                    FICHAF = string.IsNullOrEmpty(this.txtfichaf.Text) ? null : this.txtfichaf.Text,
                    MONEDA = string.IsNullOrEmpty(this.txtmoneda.Text) ? null : this.txtmoneda.Text,
                    FONDO = string.IsNullOrEmpty(this.txtfondo.Text) ? null : this.txtfondo.Text,
                    POSICIONF = string.IsNullOrEmpty(this.txtposicionf.Text) ? null : this.txtposicionf.Text,
                    CLAVE_TRANSP = string.IsNullOrEmpty(this.txtcvetrasportista.Text) ? null : this.txtcvetrasportista.Text,
                    A_RELACION = string.IsNullOrEmpty(this.txtarelacion.Text) ? null : this.txtarelacion.Text,
                    ID_ANALITICO = string.IsNullOrEmpty(this.txtidanalitico.Text) ? null : this.txtidanalitico.Text,
                    TIPO_PRODUCTO = string.IsNullOrEmpty(this.txttipoproducto.Text) ? null : this.txttipoproducto.Text,
                    CEDULA = string.IsNullOrEmpty(this.txtcedula.Text) ? null : this.txtcedula.Text,
                    CONTRATO_SIIC = string.IsNullOrEmpty(this.txtcontratosiic.Text) ? null : this.txtcontratosiic.Text,
                    OCOMERCIAL = string.IsNullOrEmpty(this.txtocomercial.Text) ? null : this.txtocomercial.Text,
                    SERVICIOG = string.IsNullOrEmpty(this.txtserviciog.Text) ? null : this.txtserviciog.Text,
                    SERVICIOA = string.IsNullOrEmpty(this.txtservicioa.Text) ? null : this.txtservicioa.Text,
                    CORREOPMI = string.IsNullOrEmpty(this.txtcorreopmi.Text) ? null : this.txtcorreopmi.Text,
                    ANALITICO = string.IsNullOrEmpty(this.txtanalitico.Text) ? null : this.txtanalitico.Text
                }
                //Fin Addenda PEMEX
