<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrSorianaCEDIS.aspx.cs" Inherits="GafLookPaid.wfrSorianaCEDIS" %>
...
<link href="Styles/StyleBoton.css" rel="stylesheet" type="text/css" />
	...
	<h1>Generar CFDI soriana cedis</h1>
	...
	<tr> 
        <td class="style13"></td>
        <td class="style16"><span class="style9">&nbsp;</span></td>
        <td class="style26"></td>
        <td></td>
	...
	<asp:TabContainer ID="tabContainerAduana"  CssClass="page1" runat="server" Width="100%" 
		...
		<table width="95%">
			...
			<tr>
				...
				<td style="text-align: left">
					<asp:TextBox ID="txtTMoneda" runat="server" Height="22px"></asp:TextBox>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="text-align: left">
					<asp:TextBox runat="server" ID="txtnoProveedor" />
				</td>
				<td style="text-align: right">
				    Observaciones:
				</td>
			...
			<tr>
				...
				<td style="text-align: left">
					<asp:TextBox runat="server" ID="txtGln" />
				</td>
				<td style="text-align: right">
				    Extra Atributo:
				</td>
				<td style="text-align: left">
					<asp:TextBox ID="txtAtributo1" runat="server"></asp:TextBox>
				</td>
			</tr>
			<tr>
				<td style="text-align: right">
				...
				<td style="text-align: left">
					<asp:TextBox runat="server" ID="txtDescrip" />
				</td>
				<td style="text-align: right">
				    Extar Atributo:
				</td>
				<td style="text-align: left">
					<asp:TextBox ID="txtAtributo2" runat="server"></asp:TextBox>
				</td>
			</tr>
			 <tr>
				<td style="text-align: right">
				...
				<td style="text-align: left">
					<asp:TextBox runat="server" ID="txtNombrecorto" />
				</td>
				<td style="text-align: right">
				    Valor:
				</td>
			...
			<tr>
				...
				<td style="text-align: left">
					<asp:TextBox ID="txtTipoCambi" runat="server"></asp:TextBox>
				</td>
				<td style="text-align: right">
				    &nbsp;</td>
				<td style="text-align: left">
	...
	<table width="95%" >
		...
		<asp:CompareValidator runat="server" ID="cvPrecio"  ControlToValidate="txtPrecio" Display="Dynamic"
		 ...
		 <tr>
			<td style="text-align: right;">
				<asp:CheckBox runat="server" ID="cbIva" Text="I.V.A." AutoPostBack="True"/>  
			</td>
			<td style="text-align: left;">
				<asp:TextBox runat="server" ID="txtIvaConcepto" Text="0"/> %
