<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="wfrLiverpool.aspx.cs" Inherits="GafLookPaid.wfrLiverpool" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <link href="Styles/StyleBoton.css"  rel="stylesheet" type="text/css" />
        ...
        <ContentTemplate>
           ...
           <table>
                <caption>
                    <h1 class="style156">Generar CFDI Liverpool</h1>
                    <p class="style156">
                        &nbsp;</p>
    ...
    <table class="page2" width="100%">
                <tr>
                    <td class="text-right" style="text-align: right"><strong><span class="style155">Folio NTLINK:</span> </strong></td>
                    <td>
...
<asp:GridView runat="server" ID="gvCfdiRelacionado" AutoGenerateColumns="False" CssClass="style124"
      ...
      <asp:TabContainer ID="TabConceptosAddenda"  runat="server" Width="100%" 
                ActiveTabIndex="1">
                    ...
                    <ContentTemplate>
                        <table>
                            <tr>
                                ...
                                <td class="style8">
                                    <asp:TextBox ID="OrderIdentification_ReferenceIdentification" runat="server" CssClass="form-control2"></asp:TextBox>
                                ...
                                <td class="style8">
                                    <asp:TextBox ID="txtDeliveryNote" runat="server" CssClass="form-control2"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="BuyerSeller_GlnBuyer" runat="server" MaxLength="13" CssClass="form-control2" ></asp:TextBox>
                                </td>
                                 <td style="text-align: right;">
                                    Person or Department Name
                                </td>
                                <td>
                                    <asp:TextBox ID="txtpersonOrDepartmentName" runat="server" CssClass="form-control2"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: right;">
                                ...
                                <td>
                                    <asp:TextBox ID="txtSellerGln" runat="server" MaxLength="13" CssClass="form-control2"></asp:TextBox>
                                </td>
                                 <td style="text-align: right;">
                                    Alternate Party Identification
                                </td>
                                <td>
                                    <asp:TextBox ID="txtalternatePartyIdentification" runat="server"  CssClass="form-control2"></asp:TextBox>
                                </td>
                            </tr>
                            <tr><td></td></tr>
                        </table>
                ...
                <tr>
                 <td style="text-align: right"><asp:CheckBox runat="server" ID="cbIVA" Text="IVA" 
                         ...
                         OnCheckedChanged="cbImp_CheckedChanged" Checked="True"/></td>
                            <td>
                                <asp:DropDownList runat="server" ID="ddlIVA" AutoPostBack="True"  CssClass="form-control0">
...
<tr>
         <td class="text-right">NumeroPedimento:</td>
         <td>
             <asp:TextBox ID="txtNumeroPedimento" runat="server" CssClass="form-control2" Width="271px" />
         ...
         <td class="text-right">Partida:</td>
         <td>       
...
<asp:GridView runat="server" ID="gvInformacionAduanera" AutoGenerateColumns="False" CssClass="style124"
            ...
            <br />
            <asp:UpdateProgress AssociatedUpdatePanelID="up11" ID="UpdateProgress1"  runat="server">
			<ProgressTemplate>
                    <div align="center">
    ...
    <asp:Panel runat="server" ID="pnlBuscarConceptos" Style="text-align: center;" Width="800px" CssClass="page3"
        ...
        <p>
            <asp:TextBox runat="server" ID="txtConceptoBusqueda" CssClass="form-control2"/>&nbsp;&nbsp;&nbsp;
