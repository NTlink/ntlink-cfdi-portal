<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="wfrFacturaAddendaPlaneta.aspx.cs" Inherits="GafLookPaid.wfrFacturaAddendaPlaneta" %>
...
<asp:GridView runat="server" ID="gvCfdiRelacionado" AutoGenerateColumns="False" CssClass="style124"
      ...
      <asp:TabContainer ID="tabContainerPilgrims" runat="server" AutoPostBack = "true" Width="100%" 
    ...
    ControlToValidate="txtCantidad" ErrorMessage="Dato invalido" 
      ...
      <td>
        ...
        <table width="95%">
            <caption>
                <h1>
                    Datos Addenda Planeta</h1>
                    <br />
                    <tr>
                       <td style="text-align: right"> <span class="style160" style="color: #FF0000">*</span>Folio:</td>
                    <td>
                        <asp:TextBox ID="txtFolioAP" runat="server" CssClass="form-control2" 
                            MaxLength="7"></asp:TextBox>
                                 <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender5" runat="server"
Enabled="True" TargetControlID="txtFolioAP" FilterType="Numbers">
</asp:FilteredTextBoxExtender>
                       <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" 
            ControlToValidate="txtFolioAP" Display="Dynamic" ErrorMessage="Requerido" 
            ValidationGroup="CrearFactura"></asp:RequiredFieldValidator>
       
                        </td>
                    <td style="text-align: right"> <span class="style160" style="color: #FF0000">*</span>Empresa:</td>
                    <td>
                     <asp:DropDownList runat="server" ID="ddlEmpresaAP" AutoPostBack="True" CssClass="form-control2"  >
                      <asp:ListItem Value="RP" Text="RP" />
                      <asp:ListItem Value="PQ" Text="PQ" />
                      <asp:ListItem Value="PS" Text="PS" />
                      <asp:ListItem Value="RM" Text="RM" />
                      <asp:ListItem Value="CL" Text="CL" />
                      <asp:ListItem Value="SE" Text="SE" />
                      <asp:ListItem Value="TM" Text="TM" />
                      <asp:ListItem Value="VM" Text="VM" />
                        </asp:DropDownList>
    

            </td>
                    <td style="text-align: right"> <span class="style160" style="color: #FF0000">*</span>FechaADDOC:</td>
                    <td>
                        <asp:TextBox ID="txtFechaADDOC" runat="server" CssClass="form-control2" ></asp:TextBox>
                        <asp:CalendarExtender ID="CalendarExtender2" runat="server" Format="yyyy-MM-dd" 
                            PopupButtonID="txtFechaADDOC" TargetControlID="txtFechaADDOC" 
                            Enabled="True" />
                         <asp:CompareValidator runat="server" ID="CompareValidator4" ControlToValidate="txtFechaADDOC"
                            Display="Dynamic" ErrorMessage="* Fecha Invalida" Operator="DataTypeCheck" Type="Date" />
                          <asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" 
            ControlToValidate="txtFechaADDOC" Display="Dynamic" ErrorMessage="Requerido" 
            ValidationGroup="CrearFactura"></asp:RequiredFieldValidator>
            ...
            <td>
                <asp:TextBox runat="server" ID="txtRequisicion" MaxLength="50" 
                    CssClass="form-control2"></asp:TextBox>
                           <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender6" runat="server"
Enabled="True" TargetControlID="txtRequisicion" FilterType="Numbers">
</asp:FilteredTextBoxExtender>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" 
            ControlToValidate="txtRequisicion" Display="Dynamic" ErrorMessage="Requerido" 
            ValidationGroup="CrearFactura"></asp:RequiredFieldValidator>
                   </td>
       ...
       <table>
         <tr>
            <td style="text-align: right;" class="style126"> <span class="style160" style="color: #FF0000">*</span>Linea: </td>
            <td  style="text-align: left;">    <asp:TextBox runat="server" ID="txtLinea" CssClass="form-control2" />
                         <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender14" runat="server" Enabled="True" 
                TargetControlID="txtLinea" FilterType="Numbers"></asp:FilteredTextBoxExtender>
            </td>
            <td style="text-align: right;" class="style126"> <span class="style160" style="color: #FF0000">*</span>ProcesoProd: </td>
            <td  style="text-align: left;">
                        <asp:DropDownList runat="server" ID="ddlProcesoProd" AutoPostBack="True" CssClass="form-control2"  >
                      <asp:ListItem Value="INTER" Text="INTER" />
                      <asp:ListItem Value="INTE1" Text="INTE1" />
                      <asp:ListItem Value="LAMF1" Text="LAMF1" />
                      <asp:ListItem Value="LAMF2" Text="LAMF2" />
                      <asp:ListItem Value="CARTU" Text="CARTU" />
                      <asp:ListItem Value="PAPEL" Text="PAPEL" />
                      <asp:ListItem Value="FORRO" Text="FORRO" />
                      <asp:ListItem Value="ENCUA" Text="ENCUA" />
                      <asp:ListItem Value="ENCU2" Text="ENCU2" />
                        </asp:DropDownList>
    
              
            </td>
            <td style="text-align: right;" class="style131"> <span class="style160" style="color: #FF0000">*</span>TipoTrabajo: </td>
            <td  style="text-align: left;" class="style134">
                <asp:TextBox runat="server" ID="txtTipoTrabajo" CssClass="form-control2" />
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" 
            ControlToValidate="txtTipoTrabajo" Display="Dynamic" ErrorMessage="Requerido" 
            ValidationGroup="AgregarAddendaPlaneta"></asp:RequiredFieldValidator>
            </td>
             </tr>
             <tr>
            <td class="style131" style="text-align: right;"> <span class="style160" style="color: #FF0000">*</span>
                HojaTrabajo</td>
            <td  class="style134" style="text-align: left;">
                            <asp:TextBox runat="server" ID="txtHojaTrabajo" CssClass="form-control2" />
                              <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server"
Enabled="True" TargetControlID="txtHojaTrabajo" FilterType="Numbers">
</asp:FilteredTextBoxExtender>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator12" runat="server" 
            ControlToValidate="txtHojaTrabajo" Display="Dynamic" ErrorMessage="Requerido" 
            ValidationGroup="AgregarAddendaPlaneta"></asp:RequiredFieldValidator>
            </td>
           
            <td  class="style134" style="text-align: right;"> <span class="style160" style="color: #FF0000">*</span>Codigo
            </td>
            <td class="style134" style="text-align: left;">
                 <asp:TextBox runat="server" ID="txtCodigoAP" CssClass="form-control2" />
                  <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender12" runat="server"
Enabled="True" TargetControlID="txtCodigoAP" FilterType="Numbers">
</asp:FilteredTextBoxExtender>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" 
            ControlToValidate="txtCodigoAP" Display="Dynamic" ErrorMessage="Requerido" 
            ValidationGroup="AgregarAddendaPlaneta"></asp:RequiredFieldValidator>
            </td>
             <td  class="style134" style="text-align: right;"> <span class="style160" style="color: #FF0000">*</span>Cantidad
            </td>
            <td class="style134" style="text-align: left;">
                 <asp:TextBox runat="server" ID="txtCantidadAP" CssClass="form-control2" />
                 <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender21" runat="server"
    TargetControlID="txtCantidadAP" FilterType="Custom, Numbers" ValidChars="." Enabled="True" />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" 
            ControlToValidate="txtCantidadAP" Display="Dynamic" ErrorMessage="Requerido" 
            ValidationGroup="AgregarAddendaPlaneta"></asp:RequiredFieldValidator>

              <asp:RegularExpressionValidator id="RegularExpressionValidator22" 
            runat="server" Display="Dynamic" CssClass="alert-danger"
    ControlToValidate="txtCantidadAP" ErrorMessage="Dato invalido" 
                         ValidationExpression="[0-9]*\.?[0-9]*" 
                         ValidationGroup="AgregarAddendaPlaneta" style="font-size: medium"/>
           
            </td>
                </tr>
               <tr>
              
                <td  class="style134" style="text-align: right;"> <span class="style160" style="color: #FF0000">*</span>PrecioUnitario
            </td>
            <td class="style134" style="text-align: left;">
                 <asp:TextBox runat="server" ID="txtPrecioUnitarioAP" CssClass="form-control2" />
                       <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender7" runat="server"
    TargetControlID="txtPrecioUnitarioAP" FilterType="Custom, Numbers" ValidChars="." Enabled="True" />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" 
            ControlToValidate="txtPrecioUnitarioAP" Display="Dynamic" ErrorMessage="Requerido" 
            ValidationGroup="AgregarAddendaPlaneta"></asp:RequiredFieldValidator>

              <asp:RegularExpressionValidator id="RegularExpressionValidator3" 
            runat="server" Display="Dynamic" CssClass="alert-danger"
    ControlToValidate="txtPrecioUnitarioAP" ErrorMessage="Dato invalido" 
                         ValidationExpression="[0-9]*\.?[0-9]*" 
                         ValidationGroup="AgregarAddendaPlaneta" style="font-size: medium"/>
          </td>
       
        
                      <td  class="style134" style="text-align: right;"> <span class="style160" style="color: #FF0000">*</span>ImporteTotal
                        
            </td>
            <td class="style134" style="text-align: left;">
                 <asp:TextBox runat="server" ID="txtImporteTotal" CssClass="form-control2" />
                 <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender8" runat="server"
    TargetControlID="txtImporteTotal" FilterType="Custom, Numbers" ValidChars="." Enabled="True" />
        <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" 
            ControlToValidate="txtImporteTotal" Display="Dynamic" ErrorMessage="Requerido" 
            ValidationGroup="AgregarAddendaPlaneta"></asp:RequiredFieldValidator>

              <asp:RegularExpressionValidator id="RegularExpressionValidator4" 
            runat="server" Display="Dynamic" CssClass="alert-danger"
    ControlToValidate="txtImporteTotal" ErrorMessage="Dato invalido" 
                         ValidationExpression="[0-9]*\.?[0-9]*" 
                         ValidationGroup="AgregarAddendaPlaneta" style="font-size: medium"/>
             </td>
        </tr>
     ...
     <tr>
            <td  class="style134" style="text-align: right;"> <span class="style160" style="color: #FF0000">*</span>Descripción
            </td>
            <td colspan="4" class="style134" style="text-align: left;">
                 <asp:TextBox runat="server" ID="txtDescripcionAP" CssClass="form-control2" Width="100%" />
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" 
            ControlToValidate="txtDescripcionAP" Display="Dynamic" ErrorMessage="Requerido" 
            ValidationGroup="AgregarAddendaPlaneta"></asp:RequiredFieldValidator>
             </td>
               </tr>
     ...
     <td></td>
             <td style="text-align: right;" class="style126">&nbsp;<asp:Button 
                     ID="btnAgregarAddendaPlaneta" runat="server" class="btn btn-primary" 
                     OnClick="btnAgregarAddendaPlaneta_Click" Text="Agregar" 
                     ValidationGroup="AgregarAddendaPlaneta" />
            </td>
               ...
               <div style="height: 100%; overflow-y: scroll" >
                <asp:GridView runat="server" ID="gvAddendaPlaneta" AutoGenerateColumns="False"  CssClass="style124" Width="100%" HorizontalAlign="Center"
                    ShowHeaderWhenEmpty="True" OnRowCommand="gvAddendaPlaneta_RowCommand">
                    <Columns>
         
            <asp:BoundField HeaderText="Linea" DataField="Linea" >
            <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField HeaderText="ProcesoProd" DataField="ProcesoProd" >
            <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField HeaderText="TipoTrabajo" DataField="TipoTrabajo"  >
            <ItemStyle HorizontalAlign="Right" />
            </asp:BoundField>
              <asp:BoundField HeaderText="HojaTrabajo" DataField="HojaTrabajo" >
            <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            ...
            <ItemStyle HorizontalAlign="Center" />
                ...
                <asp:BoundField HeaderText="ImporteTotal" DataField="ImporteTotal" >
            <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
             <asp:ButtonField Text="Eliminar" CommandName="EliminarAddendaPlaneta" />
            </Columns>
            </asp:GridView>
            </div>
