<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="wfrFacturaPilgrims.aspx.cs" Inherits="GafLookPaid.wfrFacturaPilgrims" %>
...
<asp:GridView runat="server" ID="gvCfdiRelacionado" AutoGenerateColumns="False" CssClass="style124"
      ...
      <asp:TabContainer ID="tabContainerPilgrims" runat="server"  Width="100%" 
        ...
        <table width="95%">
            ...
            <td>
                <asp:TextBox runat="server" ID="txtProveedor" MaxLength="6" CssClass="form-control2"></asp:TextBox>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtProveedor" ErrorMessage="Campo obligatorio" ValidationGroup="CrearFactura"></asp:RequiredFieldValidator>
                <asp:CompareValidator ID="CompareValidator3" runat="server" Operator="DataTypeCheck"  Type="Integer" ControlToValidate="txtProveedor" ValidationGroup="CrearFactura" ErrorMessage="Dato inválido"></asp:CompareValidator>
            </td>
             <td style="text-align: right">
                Comprador: 
            </td>
            <td>
                <asp:TextBox runat="server" ID="txtComprador" MaxLength="35" CssClass="form-control2"></asp:TextBox>
        ...
        <tr>
            ...
            <td colspan="2"  style="text-align: left;" class="style134">
                <asp:TextBox runat="server" ID="txtPedidoConcepto" MaxLength="10" 
                    CssClass="form-control2" Height="29px" Width="134px"/>
                 
            </td>
            <td style="text-align: right;" class="style126">Posición: </td>
            <td colspan="2" style="text-align: left;">
                <asp:TextBox runat="server" ID="txtPosicion" MaxLength="2" CssClass="form-control2" />
        ...
        <tr>
            ...
            <td colspan="2" style="text-align: left;" class="style134">
                <asp:TextBox runat="server" ID="txtReferencia" CssClass="form-control2" />
            ...
            <td colspan="2" style="text-align: left;">
                <asp:TextBox runat="server" ID="txtPedimento" MaxLength="15" CssClass="form-control2" />
        ...
        <tr>
            ...
            <td colspan="2" class="style134" style="text-align: left;">
                <asp:TextBox ID="txtFacturaPedimento" runat="server" MaxLength="15" CssClass="form-control2"></asp:TextBox>
                <span class="style137">(Obligatorio para el proceso 08.) </span>
            </td>
            <td>
                    <asp:Button runat="server" ID="btnAgregarPilgrims" ValidationGroup="AgregarConceptoPilgrims" class="btn btn-primary" 
				 Text="Agregar" onclick="btnAgregarPilgrims_Click"/></td>
