...
{
    public partial class wfrFacturaPilgrims32 : System.Web.UI.Page
    {
        ...
        protected void gvDetalles_RowCommand(object sender, System.Web.UI.WebControls.GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName.Equals("Editar"))
            {
                ...
                //this.txtReferencia.Text = edicion.Referencia;
                //txtPedimento.Text = edicion.Pedimento;
                //txtPedidoConcepto.Text = edicion.Pedido;
                //txtPosicion.Text = edicion.Posicion;
                //txtFacturaPedimento.Text = edicion.FacturaPedimento;
                mpeEdita.Show();
            }
        }
        ...
        private facturas GetFactura(string iniciales, List<facturasdetalle> detalles)
        {
            ...
            //    //partida.
            //    partida.Referencia = detalle.Referencia;
            //    partida.Posicion = detalle.Posicion;
            //    partida.Pedido = detalle.Pedido;
            //    partida.Pedimento = (string.IsNullOrEmpty(detalle.Pedimento) ? null : detalle.Pedimento);
            //    partida.FacturaPedimento = (string.IsNullOrEmpty(detalle.FacturaPedimento) ? null : detalle.FacturaPedimento);
                
            //    partidas.Add(partida);
            //}
            //addendaPilgrims.Partida = partidas.ToArray();
            fact.AddendaPilgrims = addendaPilgrims;
