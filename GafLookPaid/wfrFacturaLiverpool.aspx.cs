...
{
    public partial class wfrFacturaLiverpool : System.Web.UI.Page
    {
        ...
        private facturas CrearFactura(List<facturasdetalle> detalles)
        {
            ...
            {
                TipoDocumento = TipoDocumento.FacturaLiverpool,
                ...
                FormaPago = this.txtMetodoPagoMulID.Text, //dlMetodoPago.SelectedValue
        ...
        private void ClearAll()
        {
            ...
            this.txtAnticipo.Text = txtNoPedido.Text = string.Empty;
            //limpiar campos adendea
            this.txtNoPedido.Text = txtBuyer.Text = txtSeller.Text = txtFechaPedido.Text =
                txtDeptoContacto.Text = txtProveedor.Text = txtAprob.Text = txtFechaContra.Text =
                txtContrarecibo.Text = string.Empty;
        ...
        private DatosFacturaAduanera GetDatosFacturaAduana()
        {
            ...
            {
                NumeroPedido = txtNoPedido.Text,
                Buyer = txtBuyer.Text,
                Seller = txtSeller.Text,
                FechaPedido = txtFechaPedido.Text,
                DeptoContacto = txtDeptoContacto.Text,
                Proveedor = txtProveedor.Text,
                Aprob = txtAprob.Text,
                Contrarecibo = txtContrarecibo.Text,
                FechaContrarecibo = txtFechaContra.Text,
