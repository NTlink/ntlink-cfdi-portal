<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="wfrComplementoServicioParcialConstruccion.aspx.cs" Inherits="GafLookPaid.wfrComplementoServicioParcialConstruccion" %>
...
<asp:UpdatePanel ID="up1" runat="server"  UpdateMode="Conditional" >
        <ContentTemplate>
            ...
            <table>
                <caption>
                    <h1 class="style156">Generar Servicio Parcial Contruccion</h1>
                    <p class="style156">
                        &nbsp;</p>
...
<asp:GridView runat="server" ID="gvImpuestos" AutoGenerateColumns="False" CssClass="style124"
       ...
       <asp:Panel ID="Panel4" runat="server"  CssClass="page1" BorderStyle="Double" HorizontalAlign="Center" Width="100%" > 
          <asp:CheckBoxList ID="ckeckboxlist1" runat="server" Font-Bold="True"  Width="100%"
             ...
             <asp:ListItem>Servicio Parcial Construccion</asp:ListItem>
