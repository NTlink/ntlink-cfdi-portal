...
namespace GafLookPaid
{
    public partial class Amazon : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                try
                {
                    ...
                    ViewState["AtributosAmazon"] = new List<AmazonLosAtributos>();
        ...
        private bool ValidarFactura()
        {
            ...
            var atributos = ViewState["AtributosAmazon"] as List<AmazonLosAtributos>;
            if (atributos.Count < 1)
            {
                this.lblError.Text = "Falta agregar atributos de la addenda";
                return false;
        ...
        private facturas CrearFactura(List<facturasdetalle> detalles)
        {
            ...
            {
                TipoDocumento = TipoDocumento.Amazon,
            ...
            //var ret = decimal.Parse(lblRetencionIva.Text, NumberStyles.Currency); //se quito iva retencion rgv
            decimal ret = 0.0M;
            if (ret > 0)
            ...
            //datos AddendaAmazon---------------rgv
             fact.FacturasAddenAmazon = GetDatosFacturaAddenda();
        ...
        private void ClearAll()
        {
           ...
           // this.txtAnticipo.Text = txtTipomoneda.Text = string.Empty;
            ...
            //this.lblRetencionIva.Text = 0M.ToString("C");//sequito el iva retencion
        ...
        {
            var conceptos = ViewState["AtributosAmazon"] as List<AmazonLosAtributos>;
            if (conceptos != null && conceptos.Count > 0)
            {
            ...
            this.gvAmazon.DataSource = ViewState["AtributosAmazon"];
        ...
        private DatosAmazon GetDatosFacturaAddenda()
        {
            //campos txt factura addenda honda
            DatosAmazon dfa = new DatosAmazon();
            dfa.TextoLibre = txtTextoLibre.Text;
        ...
        protected void ddlMetodoPago_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                CheckNA.Visible = true;
                Check01.Visible = true;
                Check02.Visible = true;
                Check03.Visible = true;
                Check04.Visible = true;
                Check05.Visible = true;
                Check06.Visible = true;
                Check08.Visible = true;
                Check28.Visible = true;
                Check29.Visible = true;
                Check99.Visible = true;
                txtMetodoPagoMul.Visible = true;

            }
            else
            {
                CheckNA.Visible = false;
                Check01.Visible = false;
                Check02.Visible = false;
                Check03.Visible = false;
                Check04.Visible = false;
                Check05.Visible = false;
                Check06.Visible = false;
                Check08.Visible = false;
                Check28.Visible = false;
                Check29.Visible = false;
                Check99.Visible = false;
                txtMetodoPagoMul.Visible = false;
        ...
        */
        ...
        protected void gvAmazon_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName == "EliminarAtributo")
            {
                ...
                ViewState["AtributosAmazon"] = atributos;
                this.BindAddendaToGridView();
        ...
        {
            if (string.IsNullOrEmpty(this.txtIdentificacionUnica.Text.Trim()) ||
               string.IsNullOrEmpty(this.txtNombreDelAtributo.Text.Trim()) ||
               string.IsNullOrEmpty(this.txtValorDelAtributo.Text.Trim())
               )
            {
            ...
            var atributos = ViewState["AtributosAmazon"] as List<AmazonLosAtributos>;
            var atributo = new AmazonLosAtributos();

            atributo.identificacionUnica = txtIdentificacionUnica.Text;
            atributo.nombreDelAtributo = txtNombreDelAtributo.Text;
            atributo.valorDelAtributo = txtValorDelAtributo.Text;
            
            atributos.Add(atributo);
            ViewState["AtributosAmazon"] = atributos;
            txtIdentificacionUnica.Text="";
            txtNombreDelAtributo.Text="";
            txtValorDelAtributo.Text="";
