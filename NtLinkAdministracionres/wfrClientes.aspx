...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server" >
    ...
    <table >
        ...
        <tr>
            ...
            <td><asp:TextBox runat="server" ID="txtNombreAdmin" Width="269px" /></td>
            <td style="text-align: right">Iniciales del Administrador:</td>
            <td><asp:TextBox runat="server" ID="txtInicialesAdmin" Width="269px" /></td>
        </tr>
        
        <tr>
            <td style="text-align: right">Saldo Emision</td>
            <td>
                <asp:TextBox runat="server" ID="txtSaldoEmision" Width="269px"></asp:TextBox>
            ...
            <td>
                <asp:TextBox runat="server" ID="txtSaldoTimbrado" Width="269px" ></asp:TextBox>
