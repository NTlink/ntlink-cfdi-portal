...
namespace GafLookPaid
{
    public partial class wfrComplementoServicioParcialConstruccion : Page
    {
            ...
            if (!this.IsPostBack)
            {
                try
                {
                  //  ImpuestosLocales.Visible = false;
                    servicioConstruccion.Visible = false;
        ...
        {
            //this.ClearAll();
            Response.Redirect("wfrFacturaComplementos.aspx");
        }
        ...
        */
        ...
        {
            if (ckeckboxlist1.Items[0].Selected == true)
                //ImpuestosLocales.Visible = true; 
                servicioConstruccion.Visible = true;
            else
                servicioConstruccion.Visible = false;
               // ImpuestosLocales.Visible = false; 
        ...
        protected void ddlClaveUnidad_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlClaveUnidad.SelectedValue == "0")
            {
                ...
                cu = cliente.ConsultarClaveUnidadAll().Select(
                        ...
                        {
                            Nombre = p.c_ClaveUnidad1 + " - " + p.Nombre,
