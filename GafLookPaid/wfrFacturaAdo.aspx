<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="wfrFacturaAdo.aspx.cs" Inherits="GafLookPaid.wfrFacturaAdo" %>
...
<script type="text/javascript">
    ...
    <asp:UpdatePanel ID="up1" runat="server"  UpdateMode="Conditional" >
        <ContentTemplate>
            ...
            <table>
                <caption>
                    <h1 class="style156">Generar CFDI Ado</h1>
                    <p class="style156">
                        &nbsp;</p>
           ...
           <table class="page2" width="100%">
            ...
            <asp:TabContainer ID="tabContainerAduana" runat="server" ActiveTabIndex="1" 
                ...
                <table width="95%"><caption><h1 class="style156">Datos ado</h1><br /><br />
                <tr><td class="style157" style="text-align: right">Valor: </td>
                <td class="style165" style="text-align: right;">
                <asp:TextBox ID="txtValor" runat="server" CssClass="form-control2" >
                </asp:TextBox></td><td class="style164">Proveedor: </td>
                <td style="text-align: left">
                <asp:TextBox ID="txtProveedor" runat="server" CssClass="form-control2"></asp:TextBox></td></tr>
