<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrMabe.aspx.cs" Inherits="GafLookPaid.wfrMabe" %>
		...
		<table width="95%">
			...
			<tr>
				...
				<td style="text-align: left;">
					<asp:TextBox runat="server" ID="txtMonedatipoMoneda" />
				</td>
				<td style="text-align: right">
				    No. interior:
				</td>
				<td style="text-align: left">
					<asp:TextBox runat="server" ID="txtnoInterior" />
				</td>
			</tr>
			...
			<tr>
				...
				<td style="text-align: left">
					<asp:TextBox runat="server" ID="txtProvedorcodigo" />
				</td>
				<td style="text-align: right">
				    FechaFinal:
				</td>
			...
			<tr>
				<td style="text-align: right">
					Entrega Codigo Postal:
				</td>
				<td style="text-align: left">
					<asp:TextBox runat="server" ID="txtEntregaCodigoPostal" />
				</td>
				<td style="text-align: right">
				    Planta de Entrega:
				</td>
				<td style="text-align: left">
					<asp:TextBox runat="server" ID="txtPlantaEntrega" />
				</td>
			</tr>
			<tr>
				<td style="text-align: right">
				...
				<td style="text-align: left">
					<asp:TextBox runat="server" ID="txtnoExterior" />
				</td>
				<td style="text-align: right">
				    Calle:
				</td>
			 ...
			 <tr>
				...
				<td style="text-align: left">
					<asp:TextBox runat="server" ID="txtFechaInicial" />
					<asp:CalendarExtender runat="server" ID="CalendarExtender2" Format="dd/MM/yyyy"
						PopupButtonID="txtFechaContra" TargetControlID="txtFechaInicial" 
						Enabled="True" />
					<asp:CompareValidator runat="server" ID="CompareValidator6" ErrorMessage="* Fecha Invalida" Display="Dynamic"
					ControlToValidate="txtFechaInicial" Operator="DataTypeCheck" Type="Date" ValidationGroup="CrearFactura" />
				</td>
			</tr>
