...
<asp:UpdatePanel ID="up1" runat="server"  UpdateMode="Conditional" >
        <ContentTemplate>
            <table>
                <caption>
                    <h1 class="style156"><b>Generar CFDI Firmas</b></h1>
                    <p class="style156">
                        &nbsp;</p>
                    ...
                    <tr>
                        <td><strong><span >Empresa:</span></strong></td>
                        </span></strong>
                        <td>
            ...
            <tr><td class="text-right" style="text-align: right"><strong>
                <span class="style125" >Folio NTLINK:</span> </strong></td>
                
                <td><asp:TextBox runat="server" ID="txtFolio" CssClass="form-control2"  Enabled="False" /></td></tr>
               <tr>
       ...
       <asp:DropDownList runat="server" ID="ddlFormaPago" AutoPostBack="True" 
                         ...
                         style="margin-left: 0px" Width="213px" CssClass="form-control2">
...
<asp:ListItem runat="server"  Value="P01" Text="Por definir" ></asp:ListItem> 
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="txtProyecto" CssClass="form-control2" />
                    </td>
                    <td>
            ...
            <div id="divViasConcesionadas" runat="server" visible="true">
                ...
                <table width="100%">
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtVoBoNombre" CssClass="form-control2"></asp:TextBox>
                        </td>
                        <td>
                            Puesto:
                        </td>
                        <td>
                            <asp:TextBox runat="server" ID="txtVoBoPuesto" CssClass="form-control2"></asp:TextBox>
                        </td>
                        <td>
                            Area:
                        </td>
                        <td>
                            <asp:TextBox runat="server" ID="txtVoBoArea" CssClass="form-control2"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtRecibiNombre" CssClass="form-control2"></asp:TextBox>
                        </td>
                        <td>
                            Puesto:
                        </td>
                        <td>
                            <asp:TextBox runat="server" ID="txtRecibiPuesto" CssClass="form-control2"></asp:TextBox>
                        </td>
                        <td>
                            Area:
                        </td>
                        <td>
                            <asp:TextBox runat="server" ID="txtRecibiArea" CssClass="form-control2"></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox runat="server" ID="txtAutorizoNombre" CssClass="form-control2"></asp:TextBox>
                        </td>
                        <td>
                            Puesto:
                        </td>
                        <td>
                            <asp:TextBox runat="server" ID="txtAutorizoPuesto" CssClass="form-control2"></asp:TextBox>
                        </td>
                        <td>
                            Area:
                        </td>
                        <td>
                            <asp:TextBox runat="server" ID="txtAutorizoArea" CssClass="form-control2"></asp:TextBox>
                        </td>
                    </tr>
                </table>
            </div>
...
<asp:GridView runat="server" ID="gvImpuestos" AutoGenerateColumns="False" CssClass="style124"
   ...
   <asp:ModalPopupExtender runat="server" ID="mpeCFDIG" TargetControlID="btngenerarDummy"
    ...
    <asp:Button runat="server" ID="btngenerarDummy" Style="display: none;" />
        ...
        <br />
        <%--<asp:Button runat="server" ID="btnSeleccionarConcepto" Text="Seleccionar" onclick="btnSeleccionarConcepto_Click" />&nbsp;&nbsp;--%>
        <asp:Button runat="server" ID="Button2" Text="Aceptar"  class="btn btn-primary" OnClick="btnCerrar_Click"/>
    </asp:Panel>
