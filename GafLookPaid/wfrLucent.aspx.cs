...
{
    public partial class wfrLucent : System.Web.UI.Page
    {
        ...
        private facturas GetFactura(string iniciales, List<facturasdetalle> detalles)
        {
            ...
            {
                TipoDocumento = TipoDocumento.FacturaLucent,
                LucentRef = txtFactRef.Text,
                LucentOrdenCompra = txtLucentOrden.Text,
