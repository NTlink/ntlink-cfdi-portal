<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfrDeloitted.aspx.cs" Inherits="GafLookPaid.wfrDeloitted" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
	...
	<asp:TabContainer ID="tabContainerAduana" runat="server" Width="100%" 
	    ...
	    <asp:TabPanel HeaderText="Addenda" runat="server" CssClass="page1" ID="datosAddenda"><HeaderTemplate>Addenda</HeaderTemplate><ContentTemplate><div align="center"><table width="95%"><tr><td colspan="2" style="text-align: center;"><h1>
            DATOS DELOITTE </h1></td><td colspan="2" style="text-align: center;"><h1> </h1></td></tr><tr><td style="text-align: right">No.Pedido: </td><td style="text-align: left;"><asp:TextBox runat="server" ID="txtnopedido" /></td><td style="text-align: right">
            Origen de la factura: </td><td style="text-align: left"><asp:TextBox runat="server" ID="txtorigendefactura" /></td></tr><tr><td style="text-align: right">Moneda: </td><td style="text-align: left"><asp:TextBox runat="server" ID="txtTipomoneda" /></td><td style="text-align: right">
            No. Proveedor Deloitte: </td><td style="text-align: left"><asp:TextBox runat="server" ID="txtnoproveedor" /></td></tr><tr><td style="text-align: right">
            Correo del Contacto : </td><td style="text-align: left"><asp:TextBox runat="server" ID="txtcorreocontacto" /></td><td style="text-align: right">Correo del Contacto Proveedor :
				</td> <td style="text-align: left"><asp:TextBox runat="server" ID="txtcorreoproveedor" /></td></tr><tr><td style="text-align: right">Oficina: </td><td style="text-align: left"><asp:TextBox runat="server" ID="txtoficina" /></td><td style="text-align: right">
                Nombre del Contacto Proveedor: </td><td style="text-align: left"><asp:TextBox runat="server" ID="txtnombreproveedor" /></td></tr><tr><td style="text-align: right">&nbsp;</td><td style="text-align: left">&nbsp;</td></tr></table></div><div style="width: 900px"></div></ContentTemplate></asp:TabPanel>
		<asp:TabPanel ID="tabGeneral" HeaderText="Datos Generales" CssClass="page1" runat="server"><HeaderTemplate>Conceptos</HeaderTemplate><ContentTemplate><div align="center"><h1>Conceptos</h1></div><table width="95%" ><tr><td style="text-align: right;" width="15%">Cantidad</td><td class="style1" ><asp:TextBox runat="server" ID="txtCantidad" /><asp:CompareValidator runat="server" ID="cvCantidad" ControlToValidate="txtCantidad" Display="Dynamic" Type="Double"
		 ...
		 ErrorMessage="* Precio Inválido" Type="Currency" Operator="DataTypeCheck" ValidationGroup="AgregarConcepto" /></td></tr><tr><td style="text-align: right;"><asp:CheckBox runat="server" ID="cbIva" Text="I.V.A." AutoPostBack="True" Checked="True"/></td><td style="text-align: left;"><asp:TextBox runat="server" ID="txtIvaConcepto" Text="16"/>% <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="txtIvaConcepto" Display="Dynamic" 
				...
				ValidationGroup="AgregarConcepto" ErrorMessage="* Dato Inválido" Operator="DataTypeCheck" Type="Integer" /></td></tr><tr><td style="text-align: right;" width="15%">Descripción </td><td colspan="3"><asp:TextBox runat="server" ID="txtDescripcion" Width="80%" TextMode="MultiLine" /><asp:RequiredFieldValidator runat="server" ID="rfvDescripcion" ControlToValidate="txtDescripcion" Display="Dynamic"
				 ErrorMessage="* Requerido" ValidationGroup="AgregarConcepto" /></td></tr><tr><td style="text-align: right;" width="15%"></td><td class="style1" ></td><td><asp:Button runat="server" ID="btnAgregar" Text="Agregar Concepto"  class="btn btn-primary"  ValidationGroup="AgregarConcepto" onclick="btnAgregar_Click"/></td><td>
                <asp:Button runat="server"  class="btn btn-primary"  ID="btnBuscar" 
                    Text="Buscar" onclick="btnBuscar_Click" Visible="False" Width="80px"/><asp:HiddenField ID="txtIdProducto" runat="server" /></td></tr></table><br />
                    <div style="width: 100%"><asp:GridView runat="server" ID="gvDetalles" AutoGenerateColumns="False" 
			Width="100%" ShowHeaderWhenEmpty="True" onrowcommand="gvDetalles_RowCommand" CssClass="style124"><Columns>
                ...
                </Columns></asp:GridView><br /></div></ContentTemplate></asp:TabPanel>
	</asp:TabContainer>
	<br /> <br />
