...
{
    public partial class wfrDeloitted : System.Web.UI.Page
    {
        ...
        private facturas CrearFactura(List<facturasdetalle> detalles)
        {
            ...
            {
                TipoDocumento = TipoDocumento.FacturaDeloitte,
        ...
        private DatosFacturaAduanera GetDatosFacturaAduana()
        {
            ...
            DatosFacturaAduanera dfa = new DatosFacturaAduanera
            {
                ...
                correocontacto = "dalmartinez@deloittemx.com",
                oficina = txtoficina.Text,
                noproveedor = "7303947",
                origendefactura = txtorigendefactura.Text,
                correoproveedor = "cynthia.quiroz@sistemascbt.com.mx",
                nombreproveedor = "Cynthia Quiroz",
