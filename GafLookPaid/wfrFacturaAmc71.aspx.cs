...
using requestForPaymentSpecialInstruction = ServicioLocalContract.requestForPaymentSpecialInstruction;


namespace GafLookPaid
{
    public partial class wfrFacturaAmc71 : System.Web.UI.Page
    {
        ...
        private facturas GetFactura(string iniciales, List<facturasdetalle> detalles)
        {
            try
            {
                var fact = new facturas
                               {
                                   TipoDocumento = TipoDocumento.Amc71,
                                                        ...
                                                        new requestForPaymentReferenceIdentification()
                                                            {
                                                                //! CHANGE. PARSE ENUM
                                                                type =
                                                                    (requestForPaymentReferenceIdentificationType)
                                                                    Enum.Parse(
                                                                        typeof (
                                                                            requestForPaymentReferenceIdentificationType
                                                                            ),
                                                                        AdditionalInformation_ListBox_Type.
                                                                            SelectedValue),
                                                                Value =
                                                                    AdditionalInformation_ReferenceIdentification.
                                                                    Text
                                                            },
                                                    };
                ...
                request.seller.alternatePartyIdentification.type =
                    requestForPaymentSellerAlternatePartyIdentificationType.SELLER_ASSIGNED_IDENTIFIER_FOR_A_PARTY;
                //! Alternate PrtId
                                           ...
                                           new requestForPaymentCurrency()
                                               {
                                                   ...
                                                   currencyISOCode = (requestForPaymentCurrencyCurrencyISOCode)
                                                                     Enum.Parse(
                                                                         typeof (
                                                   ...
                                                   currencyFunction = new requestForPaymentCurrencyCurrencyFunction[]
                                                                          {
                                                                              (requestForPaymentCurrencyCurrencyFunction
                                                                              ) Enum.Parse
                                                                                    (typeof (
                                                                                         requestForPaymentCurrencyCurrencyFunction
                                                                                         ),
                ...
                request.allowanceCharge = new requestForPaymentAllowanceCharge[]
                                                  {
                                                      new requestForPaymentAllowanceCharge()
                                                          {
                                                              settlementType =
                                                                  requestForPaymentAllowanceChargeSettlementType.
                                                                  BILL_BACK,
                                                              allowanceChargeType =
                                                                  requestForPaymentAllowanceChargeAllowanceChargeType.
                                                                  ALLOWANCE_GLOBAL,
                                                              monetaryAmountOrPercentage =
                                                                  new requestForPaymentAllowanceChargeMonetaryAmountOrPercentage
                                                                  ()
                                                                      {
                                                                          rate =
                                                                              new requestForPaymentAllowanceChargeMonetaryAmountOrPercentageRate
                                                                              ()
                                                                                  {
                                                                                      @base =
                                                                                          requestForPaymentAllowanceChargeMonetaryAmountOrPercentageRateBase
                                                                                          .INVOICE_VALUE,
                                                                                      //Obligatorio Vista.|
                                                                                      percentage =
                                                                                          Decimal.Parse(
                ...
                foreach (var comprobanteConcepto in detalles)
                {
                    ...
                    li.AdditionalInformation = new requestForPaymentLineItemAdditionalInformation()
                                                   {
                                                       referenceIdentification =
                                                           new requestForPaymentLineItemAdditionalInformationReferenceIdentification
                                                           ()
                                                               {
                                                                   type =
                                                                       requestForPaymentLineItemAdditionalInformationReferenceIdentificationType
                                                                       .ON,
                    ...
                    //UNSET IF ADDENDA HOME DEPOT IS USED
                        ...
                        li.totalLineAmount.grossAmount = new requestForPaymentLineItemTotalLineAmountGrossAmount()
                                                             {
                                                                 Amount = comprobanteConcepto.Total,
                                                             };
