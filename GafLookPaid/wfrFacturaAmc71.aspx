<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="wfrFacturaAmc71.aspx.cs" Inherits="GafLookPaid.wfrFacturaAmc71" %>
        ...
        <ContentTemplate>
            ...
            <table width="100%" style="text-align:left">
                <tr runat="server" id="trDonativo" visible="False">
                    ...
                    <td class="style18">    <asp:TextBox runat="server" ID="txtDonatAutorizacion"></asp:TextBox>
        ...
        <tr>
         ...
         <td></td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox runat="server" ID="txtProyecto" Width="204px" />
                    </td>
                </tr>
                <tr>
                    <td style="text-align:right" class="style17">
            ...
            <asp:TabContainer runat="server"   ID="TabConceptosAddenda" Width="100%" 
                    ...
                    <ContentTemplate>
                        <table width="95%">
                            ...
                            <tr>
                                ...
                                <td style="text-align: left;" class="style126">
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td class="style127">
                                    <asp:Button runat="server" ID="btnAgregar" Text="Agregar Concepto" ValidationGroup="AgregarConcepto"
                ...
                <asp:TabPanel runat="server" HeaderText="Addenda AMC 7.1" CssClass="page2" ID="TabAddendaAmc">
                    <ContentTemplate>
                        <asp:TabContainer runat="server" ID="Options" Width="100%" ActiveTabIndex="3">
                            ...
                            <asp:TabPanel ID="TabPanel3" runat="server" HeaderText="TabPanel3">
                                ...
                                <ContentTemplate>
                                    <table style="width: 95%">
                                        <tr>
                                            <td style="text-align: center; font-weight: 700; font-size: large;" width="15%" 
                                                colspan="6">
                                                <span >Buyer</span>
                                            </td>
                                        </tr>
            ...
            <br/>
            <asp:ValidationSummary runat="server" ValidationGroup="CrearFactura"/>
