<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="wfrFacturaFirma.aspx.cs" Inherits="GafLookPaid.wfrFacturaFirma" %>
               ...
               <tr>
                ...
                <tr>
                   <td style="text-align: right; font-weight: 700;" class="style141">
                    ...
                    <td >
                        <asp:DropDownList runat="server" ID="ddlTipoDocumento" AutoPostBack="True" OnSelectedIndexChanged="ddlTipoDocumento_SelectedIndexChanged" Width="213px" Height="18px">
                ...
                <td class="style146">
                    <asp:TextBox ID="txtConfirmacion" runat="server" Width="210px" />
                    </td>
                     <td style="text-align: right; font-weight: 700;" class="style144">
                        Moneda:
                    </td>
...
<asp:GridView runat="server" ID="gvCfdiRelacionado" AutoGenerateColumns="False" CssClass="style124"
     ...
     <cc1:DropDownListChosen ID="ddlClaveUnidad" runat="server"  CausesValidation="false" 
            ...
            DataPlaceHolder="Escriba aquí..." AllowSingleDeselect="true" Height="16px">                
                        ...
                        &nbsp;</td>
                    <td style="text-align: right; font-weight: 700;"> Unidad*</td>
                    <td style="text-align: left" class="style149">
                        <asp:TextBox runat="server" ID="txtUnidad" />&nbsp;
                       </td>
                       <td style="text-align: right; font-weight: 700;">Código* </td>
                <td style="text-align: left">
                ...
                <tr>
                    ...
                    <td class="style1">
                        <asp:TextBox runat="server" ID="txtCantidad" Width="174px" />
                ...
                <tr>
                   ...
                   <td>  <asp:RequiredFieldValidator runat="server" ID="rfvDescripcion" ControlToValidate="txtDescripcion"
                           ...
                           <td style="text-align: right; font-weight: 700;" width="15%">CuentaPredial</td>
                            <td>
                                <asp:TextBox ID="txtCuentaPredial" runat="server" Width="174px" />
                             </td>
                           <td></td>
                            <td></td>
                  ...
                  <td><asp:Button ID="btnBuscarHistorico" runat="server" class="btn btn-primary" 
                    ...
                    <td></td>
                    <td style="text-align: right; font-weight: 700; font-size: small;" width="94%">Campos Obligatorios (*)</td>
                     </tr>
            </table><br />
    ...
    <div>
        ...
        <asp:Panel ID="Panel1" runat="server"  CssClass="page1" BorderStyle="Double" HorizontalAlign="Left" Width="100%" > 
         		<asp:CheckBox runat="server" ID="cbImpuestos" Text="Impuestos" 
                    ...
                    style="font-weight: 700" Enabled="False"/>
