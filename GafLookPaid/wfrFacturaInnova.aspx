<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="wfrFacturaInnova.aspx.cs" Inherits="GafLookPaid.wfrFacturaInnova" %>
...
<script type="text/javascript">
    ...
    <asp:UpdatePanel ID="up1" runat="server"  UpdateMode="Conditional" >
        <ContentTemplate>
            ...
            <table>
                <caption>
                    <h1 class="style156">Generar Addenda Innova</h1>
                    <p class="style156">
                        &nbsp;</p>
           ...
           <table class="page2" width="100%">
            ...
            <asp:TabContainer ID="tabContainerAduana" runat="server" ActiveTabIndex="1" AutoPostBack = "true"
                ...
                <table width="95%"><caption><h1 class="style156">Datos Innova</h1><br /><br />
                <tr><td class="style157" style="text-align: right">type: </td>
                <td class="style165" style="text-align: right;">
                <asp:TextBox ID="txttype" runat="server" Text="PO" CssClass="form-control2" Enabled="false" >
                </asp:TextBox></td><td class="style164">referenceIdentification: </td>
                <td style="text-align: left">
                <asp:TextBox ID="txtreferenceIdentification" runat="server" CssClass="form-control2"></asp:TextBox></td></tr>
                <tr><td class="style157" style="text-align: right">&nbsp;</td>
                <td class="style165" style="text-align: left">&nbsp;</td><td class="style164">&nbsp;</td>
                <td style="text-align: left"> <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender2" runat="server"
    TargetControlID="txtreferenceIdentification" FilterType="Custom, Numbers" ValidChars="." />
    <asp:RegularExpressionValidator id="RegularExpressionValidator5" runat="server" Display="Dynamic" CssClass="alert-danger"
    ControlToValidate="txtreferenceIdentification" ErrorMessage="Dato invalido" 
                ...
                <tr><td class="style157" style="text-align: right">&nbsp;</td>
                <td class="style165" style="text-align: left">&nbsp;</td><td class="style164"></td>
                <td style="text-align: left">&nbsp;</td></tr><tr>
                <td class="style157" style="text-align: right">&nbsp;</td>
                <td class="style165" style="text-align: left">&nbsp;</td></tr>
            ...
            DataPlaceHolder="Escriba aquí..." AllowSingleDeselect="True"  
                    ...
                    <td>
                        ...
                        <td><asp:TextBox ID="txtNoIdentificacion" runat="server" CssClass="form-control2" 
                             /></td><td class="style138"><input type="button" value="BuscadorSAT" onclick="javascript: window.open('http://200.57.3.46:443/PyS/catPyS.aspx', '', 'width=600,height=400,left=50,top=50,toolbar=yes');" class="btn btn-primary" /></td>
