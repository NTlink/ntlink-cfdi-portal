...
{
    public partial class wfrFacturaAduanal32 : System.Web.UI.Page
    {
        ...
        private void ClearAll()
        {
            ...
            //limpiar campos addende
            this.txtAnticipo.Text = txtGuiaMaster.Text = txtReferenciaInterna.Text =txtGuiaHouse.Text = 
                txtReferenciaPascal.Text = txtTipoCambioFletes.Text =  txtAduana.Text =  txtTipoOperacion.Text = 
                txtPedimento.Text = txtValorAduana.Text = txtTipoCambioPedimento.Text = txtMercancia.Text = txtTerr.Text = 
                TextBox1.Text = txtDiasCredito.Text = txtPesoBruto.Text = string.Empty;
        ...
        protected void btnAgregarConceptoAduana_Click(object sender, EventArgs e)
        {
            ...
            var detalle = new facturasdetalle
            {
                ...
                Descripcion2 = this.txtNoFactura.Text,Unidad = "",Cantidad = 1,Codigo = ""
            };
