...
{
    public partial class wfrFacturaAduanalCartaPorte : System.Web.UI.Page
    {
        #region Definicion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                try
                {
                    ...
                    if ((ViewState["conceptosAduana"] as List<facturasdetalle>) == null)
                    {
                        ViewState["conceptosAduana"] = new List<facturasdetalle>();
                    }
        ...
        protected void ddlEmpresa_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            using (cliente as IDisposable)
            {
                ...
                this.BindDetallesToGridView();
                var addenda = new List<ConceptosCartaPorte>();
                ViewState[AddendaConcepto] = addenda;
                UpdateAddendaGridView();
        ...
        private facturas CrearFactura(List<facturasdetalle> detalles)
        {
            ...
            //info aduanal
            //TODO CAMPO LIST OBJECT FROM GET DATOS
