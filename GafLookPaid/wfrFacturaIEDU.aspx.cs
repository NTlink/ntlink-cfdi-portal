...
namespace GafLookPaid
{
...

    {
            ...
            if (!this.IsPostBack)
            {
                try
                {
                    ...
                    using (cliente as IDisposable)
                    {
                        ...
                        //------------catalogos grandes----------------------
                        /*ddlClaveUnidad.DataSource = cliente.ConsultarClaveUnidadAll().Where(p => p.Nombre == "
                         * 
                         * " || p.Nombre == "Unidad de servicio" || p.Nombre == "Kilogramo"
                        ...
                        ddlClaveUnidadE.SelectedValue = "E48";
                        //--------------------------------------------
        ...
        protected void btnLimpiar_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect("wfrFacturaIEDU.aspx");
        ...
        private void Clear()
        {
            this.txtCodigo.Text = this.txtDescripcion.Text = this.txtDetalles.Text = this.txtPrecio.Text =
                this.txtCantidad.Text = this.txtUnidad.Text = txtNoIdentificacion.Text = txtDescuento.Text = txtCuentaPredial.Text = txtdsc.Text = txtNombreAlumno.Text=txtcurp.Text =txtrfcpago.Text =txtautRVOE.Text = txtrfcpago.Text = string.Empty;
        }
        ...
        private void ClearAll()
        {
            ...
            //this.txtautRVOE.Text = "";
            //this.txtNombreAlumno.Text = "";
            //this.txtcurp.Text = "";
            //this.ddlniveleducativo.SelectedValue = "Preescolar";
            //this.txtrfcpago.Text = "";
        ...
        */
        ...
        protected void ddlClaveUnidad_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (ddlClaveUnidad.SelectedValue == "0")
            {
                ...
                ddlClaveUnidad.SelectedValue = "E48";
            }
        }
