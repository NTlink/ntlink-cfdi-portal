...
{
    public partial class wfrCorporativoAduanal : System.Web.UI.Page
    {
        ...
        private facturas CrearFactura(List<facturasdetalle> detalles)
        {
            ...
            {
                TipoDocumento = TipoDocumento.CorporativoAduanal,
        ...
        private void ClearAll()
        {
           ...
           // this.txtMetodoPago.Text = this.txtCuenta.Text =
            this.txtSerie.Text = this.txtDiasRevision.Text = string.Empty;
            //limpiar campos addende
            this.txtAnticipo.Text = txtGuiaMaster.Text  = txtGuiaHouse.Text =
            txtTipoCambioFletes.Text = txtAduana.Text = txtTipoOperacion.Text =
            txtValorAduana.Text = txtTipoCambioPedimento.Text = txtMercancia.Text = txtTerr.Text =
            TextBox1.Text = txtPesoBruto.Text = string.Empty;
