...
{
    public partial class wfrSorianaTienda : System.Web.UI.Page
    {
        ...
        protected void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            var detalle = new facturasdetalle
            {
               ...
               // Total = Decimal.Round(decimal.Parse(this.txtPrecio.Text) * decimal.Parse(this.txtCantidad.Text), mon),
                ...
                //Proveedor = Convert.ToInt32(txtProveedorPedidos.Text),
                //Remision = txtRemisionpedid.Text,
                //folioPedido = txtFolioPedido.Text,
                //tienda = short.Parse(txtTiendaPedido.Text),
                //codigo = Convert.ToDecimal(txtCodigo.Text),
                //cantidadUnidadCompra = Convert.ToDecimal((txtUnidad.Text)),
                //costoNetoUnidadCompra = Convert.ToDecimal((txtPrecio.Text)),
               // porcentajeIEPS = 0,
                //porcentajeIVA = 0
        ...
        private facturas CrearFactura(List<facturasdetalle> detalles)
        {
            ...
            var fact = new facturas
            {
                ...
                TipoDocumento = TipoDocumento.FacturaSorianaTienda,
                ...
                //Metodo = this.ddlMetodoPago.SelectedValue != "Mixto" ? this.ddlMetodoPago.SelectedValue : txtMetodoPago.Text,
        ...
        private DatosFacturaAduanera GetDatosFacturaAduana()
        {
            ...
            DatosFacturaAduanera dfa = new DatosFacturaAduanera
            {
               ...
               //Remision
                ...
                ProveedorRemision = txtProAdenda.Text,
                RemisionR = txtRemision1.Text,              
                Consecutivo =txtConsecutivo.Text,
                FechaRemision =txtFechaRemision.Text,
                TiendaRemision= txtTiendaAdden.Text,
                TipoMoneda =txtTipoMoneda.Text,
                TipoBulto =txtTipoBultos.Text,
                EntrgaMercancia = txtEmercancia.Text,
                CumpleReqFiscal ="true",
                CantidadBultos = txtCBultos.Text,
                Subtotal ="0",
                Descuentos=Convert.ToDecimal(txtDesct.Text),
                IEPS= Convert.ToDecimal("0.00"),
                IVA =Convert.ToDecimal("0.00"),
                OtrosImpuestos =txtOtroImp.Text,
                Total ="0",
                CantidadPedidos =txtCpedido.Text,
                FechaEntrgaMercancia = txtFechaVencimiento.Text,
                FolioNotaEntrada = Convert.ToInt32(txtFNentra.Text),
                Observaciones = txtProyecto.Text,
                //PEDIDOS
                ProveedorPedido = txtRemision1.Text,
                RemisionPedido = txtRemision1.Text,
                FolioPedido = Convert.ToInt32(txtFNentra.Text),
                TiendaPedido ="0",
                CantidadArticulos = txtCantidadArticulos.Text,
               // articulos
                ProveedorArticulos = "0",
                RemisionArticulos = "0",
                FolioPedidoArticulos = "0",
                TiendaArticulos = "0",
               Codigo ="0",
                CantidadUnidadCompra ="0",
                CostoNetoUnidadCompra ="0",
                PorcentajeIEPS =Convert.ToDecimal("0.00"),
                PorecentajeIVA =Convert.ToDecimal("0.00"),
        ...
        {
            if (ddlMetodoPago.SelectedValue == "Mixto")
            {
