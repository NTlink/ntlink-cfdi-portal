<%@ Page Language="C#" MasterPageFile="~/Site.Master"AutoEventWireup="true" CodeBehind="wfrFacturaAduanalCartaPorte.aspx.cs" Inherits="GafLookPaid.wfrFacturaAduanalCartaPorte" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <td style="text-align:right" class="style17">
            ...
            <td>					<asp:Button runat="server" ID="btnActualizar" 
	...
	<td class="style11">
			...
			<td colspan="2">
			<asp:TextBox runat="server" ID="txtAddendaDescripcion" Width="56%" />
		...
		<tr>
			...
			<td colspan="2">
				<asp:TextBox runat="server" ID="txtAddendaValor" Width="56%" />
	...
	<div style="width: 100%">
		<asp:GridView runat="server" ID="gvDescripcionAddenda" AutoGenerateColumns="False"  CssClass="style124"
            ...
            onselectedindexchanged="gvDescripcionAddenda_SelectedIndexChanged" OnRowCommand="gvDescripcionAddenda_OnRowCommand">
			<Columns>
	...
	<table width="95%" >
		...
		<td>
			<asp:Button runat="server" ID="btnBuscar" Text="Buscar" 
                class="btn btn-primary"  onclick="btnBuscar_Click" Width="80px"/>
			<asp:HiddenField ID="txtIdProducto" runat="server" />
                ...
                <br></br>
<div colspan="3" style="overflow-y: scroll">
	...
	<p align="right">
		<asp:Button runat="server" ID="btnLimpiar" Text="Limpiar"  class="btn btn-primary" 
			onclick="btnLimpiar_Click" ViewStateMode="Enabled" Width="70px"/>&nbsp;&nbsp;&nbsp;
